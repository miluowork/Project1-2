...
<form class="layui-form layui-form-pane" action="">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.fullname}" name="date" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.type_id}" name="code" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  
  <div class="layui-form-item">
    <label class="layui-form-label">原金额:</label>
    <div class="layui-input-inline">
      <input value="${requestScope.info.activity}" name="amount" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  
  <div class="layui-form-item">
    <label class="layui-form-label">现金额:</label>
    <div class="layui-input-inline">
      <input value="${requestScope.info.tip}" name="nowamount" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.sale}" name="address_id" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.price}" name="user_id" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.nowprice}" name="assessStatus" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="${requestScope.info.collectcount}" name="status" type="text" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <button type="button" onclick="save()" style="left:230px"  class="layui-btn" lay-submit="" lay-filter="demo2">保存</button>
  </div>
</form>
